...
def send_command():
    ...
    for i in range(1, galvano_steps+1):
        commandGalvano = '[mcp_'+ galvano_axis + '=' + i*galvano_angle +']'
        serialGalvano.write(commandGalvano.encode())
        sleep(int(galvano_pause) // 1000)
...
galvano_steps_box.insert(1.0, 10)
...
galvano_delta_box.insert(1.0, 100)
...
numCOMport_trigger_box.insert(1.0, 'COM11')
...
numCOMport_galvan_box.insert(1.0, 'COM12')
